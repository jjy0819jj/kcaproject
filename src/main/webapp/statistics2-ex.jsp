								...
								<div class="col-md-12">
									<div class="single-widget checkbox-widget">
										...
										<ul class="ks-cboxtags">
											<li>
											<input type="checkbox" id="checkbox1" value="Rainbow Dash" checked>
											<label for="checkbox1">앱 진입</label>
											</li>

											<li>
											<input type="checkbox" id="checkbox2" value="Cotton Candy" checked>
											<label for="checkbox2">앱 로그인</label>
											</li>

											<li>
											<input type="checkbox" id="checkbox3" value="Rarity" checked>
											<label for="checkbox3">계좌조회</label>
											</li>
										</ul>

										<h4 class="title">기종 선택</h4>
										<ul class="ks-cboxtags">
											<li>
											<input type="checkbox" id="checkbox4" value="iOS" checked>
											<label for="checkbox4">iOS</label>
											</li>

											<li>
											<input type="checkbox" id="checkbox5" value="안드로이드">
											<label for="checkbox5">안드로이드</label>
											</li>
										</ul>
									</div>
								</div>
