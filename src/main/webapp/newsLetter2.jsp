				...
				<table>
					<tr>
						<td>
							...
							현재 (주)1조의 제품인 RemoteView와 Aiworks에 관련된 윈도우 어플리케이션의 개발업무를 담당하고 있습니다.
							</p>
							<br>
							...
							2014년에 Aiworks의 메이저 업데이트 업무에 참여했었습니다.
							약 1년에 걸쳐 대대적인 개발이 진행되었습니다.
							업데이트가 성공하고 글로벌 고객사 전체에 개발된 어플리케이션이 잘 동작했을 때의 짜릿함.쾌감.보람. “아, 이 맛에 개발한다!”
							</p>
							<br>
							...
							개발 업무를 계속하다 보면 배려와 소통의 중요성을 많이 느끼게 됩니다. 
							IT 기술이 발전할수록 협업의 중요성이 커지고 있습니다. 
							혼자 개발하는 상용 솔루션은 이제 존재하지 않는다고 해도 과언이 아닙니다.
							 따라서 기술에 대한 전문성이 충분하더라도 상대방을 배려하고 적극적으로 커뮤니케이션 하지 않으면 목표를 달성하기 어렵습니다. 
							 책임감 또한 중요합니다. 
							 본인 모듈에 대한 책임감은 기본입니다. 
							 추가로 이기종(안드로이드, IOS, 웹) 개발자가 개발을 완료할 수 있도록 협업하는 것도 책임의 범위로 보고 책임감 있는 모습을 보여줘야 합니다. 
							 본인이 담당한 부분의 프로그래밍이 끝났더라도 동일한 목표로 협업중인 이기종 개발자가 함께 목표를 달성할 수 있게 디버깅 해주거나 테스트 코드를 작성하는 것도 
							 책임의 범위에 포함해서 생각할 필요가 있습니다.
							 이와 함께 자신의 생각을 동료들과 함께 만들어가고 펼치겠다는 주인의식과 창조적인 마인드가 필요해요.
							</p>
							<br>
